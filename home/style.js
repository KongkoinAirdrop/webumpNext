...
export const TotalMintedProgress = (props) => {
    const x = styled.div`
    margin-top:8px;
    border-radius:69px;
    height:12px;
...
export const Phase = (props) => {
    const x = styled.div`
    background-color:${props.active === 'true' ? color.secondaryLight : color.secondary};
    color:${props.active === 'true' ? color.white : color.whiteShade};
    position:relative;
    border-radius:8px;
    border:${props.active === 'true' ? '1px solid' + color.primary : '1px solid' + color.secondaryLight};
    padding:16px;
    display:flex;
    flex-direction:column;
    justify-content:center;
    ...
    ${(props.switch === 'true' && props.active === 'false') && `
        cursor:pointer;
        &:hover{
